  ...
  *)
  ...
  type Simulation(assignment:Choice<System.Func<Vector2, seq<Vector2>, seq<Vector2>>,
    ...
    member val graphics = 
      ...
      let screen = new Vector2(1800 |> float32, 1200 |> float32);
      g.PreferredBackBufferWidth <- (screen.X |> int)
      g.PreferredBackBufferHeight <- (screen.Y |> int)
    ...
    override this.Initialize() =
      ...
      this.consolas <- this.Content.Load "test"
